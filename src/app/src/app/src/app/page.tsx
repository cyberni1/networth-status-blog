...
export default function HomePage() {
  ...
  const topCategories = [
    { name: "Tech-Milliardäre", count: 127 },
    { name: "Sport-Stars", count: 89 },
    { name: "Entertainment", count: 156 },
    { name: "Influencer", count: 234 }
  ];
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 pt-24">
        <div className="relative z-10 text-center max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="luxury-btn text-lg px-8 py-4 flex items-center">
              Entdecke die Reichsten <ArrowRight className="w-5 h-5 ml-2" />
            </button>
            <button className="glass-base border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-full flex items-center">
