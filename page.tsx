        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="luxury-btn text-lg px-8 py-4">
              Entdecke die Reichsten <ArrowRight className="w-5 h-5 ml-2 inline" />
            </button>
          ...
          <div className="glass-card">
            <div className="mb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Bleib auf dem <span className="wealth-gradient">Laufenden</span>
              </h2>
              <p className="text-white/70 text-lg">
                Erhalte die neuesten Updates zu Vermögenswerten, Investments und Erfolgsgeschichten direkt in dein Postfach
              </p>
            </div>
